...
class Pubmedclip(nn.Module):
    ...
    def forward(self, image, apply_aug = True):
        ...
        # patch_embeddings = patch_embeddings.view(batch_size * num_patches, embedding_dim)  # Flatten for MLP
        # projected_embeddings = self.mlp(patch_embeddings)  # Project to 1408 dimensions
